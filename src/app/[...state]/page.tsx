...
export async function generateMetadata({ params }: any) {
  try {
    ...
    if (!state || !city || !category) {
      return {
        title:
          "Find Professional Electricians Contractors | ChoozPainters Directory",
        description:
          "Discover licensed and insured Electricians Contractors in your area. Compare reviews, ratings, and get free quotes from verified professionals.",
        robots: "index, follow",
        keywords:
          "Electricians Contractors, house painters, commercial painters, painting services",
      };
    }
    ...
    const categoryCode = "Electricians Contractors";

    // ENHANCED: More detailed and unique title
    const title = `${cityName}, ${stateCode} ${categoryCode} | Licensed Painters Near You`;
    const fullUrl = `https://choozelectricians.com/${state}/${city}/${category}`;

    // ENHANCED: More comprehensive description
    const description = `Find top-rated Electricians Contractors in ${cityName}, ${stateCode}. Browse verified local painters with customer reviews, licensing information, and competitive pricing. Get free estimates from trusted professionals serving ${cityName} and surrounding areas.`;

    // ENHANCED: Location-specific keywords
    const keywords = `${cityName} Electricians Contractors, ${stateCode} painters, house painters ${cityName}, commercial painting ${cityName}, interior painters ${cityName}, exterior painters ${stateCode}`;
    ...
    return {
      ...
      openGraph: {
        ...
        images: [
          {
            url: `https://choozelectricians.com/images/painters-${state}-${city}.jpg`,
            width: 1200,
            height: 630,
      ...
      twitter: {
        ...
        description,
        images: [
          `https://choozelectricians.com/images/painters-${state}-${city}.jpg`,
        ],
      },
    ...
    return {
      title: "Professional Electricians Contractors Directory | ChoozPainters",
      description:
        "Find licensed Electricians Contractors in your area with verified reviews and competitive pricing.",
    ...
    return (
      <main className="container mx-auto px-4 py-8">
        <h1 className="text-2xl font-bold mb-4">
          Find Local Electricians Contractors
        </h1>
        <p className="text-gray-600">
          Please specify your location to find qualified Electricians Contractors in
          your area.
        </p>
      </main>
    );
        ...
        ? contractors
            ...
            .map((contractor: ContractorData, index: number) => {
              const localBusiness: any = {
                ...
                url: `https://choozelectricians.com/${state}/${city}/${category}/${contractor.slug}`,
              };
    ...
    const schemaItems: any[] = [
      {
        ...
        description: `Directory of verified Electricians Contractors serving ${cityName}, ${stateCode}. Find licensed and insured painters in your area.`,
        url: fullUrl,
