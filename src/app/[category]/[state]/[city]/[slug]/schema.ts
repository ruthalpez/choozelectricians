...
export const generateSchema = (contractor: any, p: any) => {
  ...
  const websiteId = "https://choozelectricians.com/#website";
  const orgId = "https://choozelectricians.com/#org";
  ...
  const getAllServices = () => {
    ...
    return uniqueServices.length > 0
      ? uniqueServices
      : ["Interior Electricians", "Exterior Electricians", "Cabinet Electricians", "Commercial Electricians"];
  };
  ...
  const businessServices =
    allServices.length > 0
      ? allServices
      : ["Interior Electricians", "Exterior Electricians", "Commercial Electricians"];
  ...
  const simplifiedSchema = prune({
    ...
    isPartOf: {
      "@type": "WebSite",
      "@id": websiteId,
      name: "Chooz Electricians Directory",
      url: "https://choozelectricians.com",
    },
    publisher: {
      "@type": "Organization",
      "@id": orgId,
      name: "Chooz Electricians",
      url: "https://choozelectricians.com",
    },
  });
