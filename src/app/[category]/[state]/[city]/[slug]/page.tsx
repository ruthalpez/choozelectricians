  ...
  try {
    ...
    const description =
      ...
      `${contractorName} provides professional ${category.replace(
        "-",
        " ",
      )} services in ${cityName}, ${stateCode}. Licensed, insured, and highly rated Electricians Contractor. Get free quotes and read customer reviews.`;
    ...
    return {
      ...
      description,
      robots,
      keywords: `${contractorName}, ${categoryName}, ${cityName} ${stateCode}, Electricians Contractor, house painter, commercial painting`,
      openGraph: {
        title,
        description,
        url: fullUrl,
    ...
    return {
      title: "ChoozPainters - Professional Electricians Contractors",
      description: "Find professional Electricians Contractors in your area.",
      robots: "index, follow",
    };
  }
}
