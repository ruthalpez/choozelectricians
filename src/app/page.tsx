...
import FloatedBallon from "@/images/floated/chooz_eletricians_hot_air_balloon.png";
import ThinkingGirl from "@/images/chooz_electricians_thinking_girl.png";

import BadgeFind from "@/images/badge/chooz_electricians_find_electricians_2.png";
import BadgeVerified from "@/images/badge/chooz_electricians_verified_electricians.png";
import BadgeBestAward from "@/images/badge/chooz_electricians_best_electricians.png";
import BadgeTopAward from "@/images/badge/chooz_electricians_top_electricians.png";

import VerifiedContractors from "@/images/chooz_electricians_quality_engagement.png";
import RealReviewAnalysis from "@/images/chooz_electricians_reviews_ratings_platform.png";
import AIOptimizedProfiles from "@/images/chooz_electricians_credibility_operations.png";
...
const jsonLd = {
  ...
  "@type": "Organization",
  name: "choozelectricians",
  url: "https://www.choozelectricians.com/",
  logo: "https://www.choozelectricians.com/images/choozelectricians-logo.png",
  description: "Find local painters and painting companies in your area.",
  sameAs: [
    "https://www.facebook.com/choozelectricians",
    "https://twitter.com/choozelectricians",
    "https://www.linkedin.com/company/choozelectricians",
  ],
  contactPoint: {
    "@type": "ContactPoint",
...
export default async function Home() {
  return (
    <main>
      ...
      <div className="container xl:max-w-6xl mx-auto px-5 pt-5 pb-10">
        <div className="py-10">
          <h2 className="md:text-center text-[35px] lg:text-[48px] leading-10 lg:leading-15 text-[var(--clr-heading)] font-medium font-poppins">
            Chooz Electricians Directory Standards
          </h2>
          <div className="border-b-[3px] border-[var(--clr-tertiary)] max-w-[180px] md:max-w-[275px] md:mx-auto my-[30px]" />
          <div className="!space-y-6">
            <p>
              Chooz Electricians specializes in finding, researching, and
              verifying Electricians contractors around the country. Our process
              ensures that you get a snapshot of all of most important
              information to compare Electricians companies in your local area.
              This ensures that you can quickly contact multiple Electricians
              companies without having to waste time searching all over the
              internet to find the best Electricians professionals for your next
              painting project.
            </p>
          </div>
          <div className="flex flex-wrap items-center md:items-start justify-center my-10 gap-15 md:gap-0">
            <ImageBox
              image={BadgeFind.src}
              alt="Icon showing three painting company storefronts labeled ABC Electricians, Star Electricians, and XYZ Electricians, representing comparison of local painters"
            ...
            <ImageBox
              ...
              alt="Chooz Electricians Certified Badge for 2025"
              heading="Chooz Electricians Certified"
              className="w-[200px]"
            />
            <div className="hidden md:block mt-16 flex-1 border-t-2 border-black border-dashed" />
            <ImageBox
              image={BadgeTopAward.src}
              alt="Icon of a painter's tool kit inside a hexagon badge, representing an online platform to find local Electricians Contractors"
          ...
          <div className="flex flex-col lg:flex-row gap-15 lg:gap-30">
            <div className="w-full lg:w-[60%]">
              ...
              <p>
                ...
                Chooz Electricians scoring system, which considers over 40
      ...
      {/* Find Electricians Technicians Near You */}
      <div className="bg-[#f4f4f4]">
        ...
        <div className="pt-10">
          <div className="flex flex-col lg:flex-row gap-15 lg:gap-30">
            <div className="w-full lg:w-2/3">
              <h2 className="text-[35px] lg:text-[48px] leading-10 lg:leading-15 text-[var(--clr-heading)] font-medium font-poppins">
                We Help You Find The Top Electricians In Your Area
              </h2>
              <div className="border-b-[3px] border-[var(--clr-tertiary)] max-w-[275px] my-[30px]" />
              <p>
                Part of what makes Chooz Electricians different from other
                directories is that we only gather the information you need to
                make an effective comparison between the Electricians
                contractors in your area. We don’t offer sponsored ads and we
                only list companies based on your geographical search.
              </p>
            </div>
            <div className="w-full lg:w-1/3">
              <Image
                src={FloatedBallon.src}
                alt="Illustration of two people in a blue and white hot air balloon with the Chooz logo, representing Electricians directory exploration and discovery"
                width={300}
                height={300}
