...
const PricingListVerified = [
  "Done for you expanded listing page on Chooz Electricians",
  ...
  return (
    <>
      <iframe
        ...
        data-form-name="Chooz Electricians - Free Company Listing"
        data-height="2879"
        data-layout-iframe-id="inline-JVjrm4zYhdqPTTGriPzK"
        data-form-id="JVjrm4zYhdqPTTGriPzK"
        title="Chooz Electricians - Free Company Listing"></iframe>
  ...
  return (
    <>
      <iframe
        ...
        data-deactivation-type="neverDeactivate"
        data-deactivation-value=""
        data-form-name="Chooz Electricians - Preferred Listing Form"
        data-height="2879"
        data-layout-iframe-id="inline-e1HMvhgCBPt3rYfbqrzj"
        data-form-id="e1HMvhgCBPt3rYfbqrzj"
        title="Chooz Electricians - Preferred Listing Form"></iframe>
      <script src="https://link.msgsndr.com/js/form_embed.js"></script>
    </>
  );
};
    ...
    <main className="primary-bg-gradient text-white">
      ...
      <div className="container xl:max-w-[1340px] mx-auto p-0 sm:py-20 relative z-10">
        <div className="flex flex-wrap justify-center gap-28">
          <CardPricing
            title="Your Chooz Electricians Listing Page"
            description="For a limited time we are offering free Chooz Electricians Verified Listing to all Electricians Contractors that verify their company information and claim their profile page."
            price="Free"
