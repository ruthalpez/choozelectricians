      ...
      <div className="container xl:max-w-[1340px] mx-auto px-5 pt-5 pb-10">
        <div className="mb-5">
          <h1 className="heading-secondary font-poppins">
            Chooz Electricians Terms of Service
          </h1>
          <p>
            These Terms of Service govern your use of the website located at
            https://choozelectricians.com and any related services provided by Chooz
            Painters.
          </p>
          <p>
            By accessing https://choozelectricians.com, you agree to abide by these
            ...
            other services provided by Chooz Electricians.
          </p>
          <p>
            We, Chooz Electricians, reserve the right to review and amend any of
        ...
        <div className="mb-5">
          ...
          <ul className="space-list list-disc pl-5">
            ...
            <li>
              ...
              other service Chooz Electricians provides
            </li>
            <li>
        ...
        <div className="mb-5">
          ...
          <p>
            ...
            are owned by or licensed to Chooz Electricians and are protected by
          ...
          <p>
            ...
            Chooz Electricians at any time.
          </p>
        </div>
        ...
        <div className="mb-5">
          ...
          <p>
            ...
            is' basis. To the extent permitted by law, Chooz Electricians makes no
          ...
          <p>
            In no event shall Chooz Electricians or its suppliers be liable for any
            ...
            materials on this website, even if Chooz Electricians or an authorized
        ...
        <div className="mb-5">
          ...
          <p>
            ...
            for general information purposes only. Chooz Electricians does not
        ...
        <div className="mb-5">
          ...
          <p>
            Chooz Electricians has not reviewed all of the sites linked to its
            website and is not responsible for the contents of any such linked
            site. The inclusion of any link does not imply endorsement, approval
            or control by Chooz Electricians of the site. Use of any such linked
