      ...
      <div className="container xl:max-w-[1340px] mx-auto px-5 pt-5 pb-10">
        <div className="mb-5">
          ...
          <p>
            ...
            your browser to refuse cookies from https://choozelectricians.com. In
