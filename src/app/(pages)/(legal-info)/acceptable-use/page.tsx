      ...
      <div className="container xl:max-w-[1340px] mx-auto px-5 pt-5 pb-10">
        <div className="mb-5">
          <h1 className="heading-secondary font-poppins">
            Chooz Electricians Acceptable Use Policy
          </h1>
          <p>
            ...
            by Chooz Electricians under any ongoing agreement. It’s designed to
            protect us, our customers and the general Internet community from
            unethical, irresponsible and illegal activity.
          </p>
          <p>
            Chooz Electricians customers found engaging in activities prohibited by
        ...
        <div className="mb-5">
          ...
          <h3 className="font-poppins text-[25px] mb-4 text-[var(--clr-heading)]">
            Unauthorized use of Chooz Electricians property
          </h3>
          <p>
            We prohibit the impersonation of Chooz Electricians, the representation
            of a significant business relationship with Concierge Doctor HQ, or
            ownership of any Chooz Electricians property (including our Products and
