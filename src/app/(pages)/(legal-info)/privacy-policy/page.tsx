      ...
      <div className="container xl:max-w-[1340px] mx-auto px-5 pt-5 pb-10">
        <div className="mb-5">
          <h1 className="heading-secondary font-poppins">
            Chooz Electricians Privacy Policy
          </h1>
          <p>
            Your privacy is important to us. It is Chooz Electricians's policy to
            ...
            you, including across our website, https://choozelectricians.com, and
