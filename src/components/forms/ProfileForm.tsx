  ...
  const submitForm = async () => {
    ...
    try {
      const submissionData = {
        ...formData,
        source: "Chooz Electricians Customer Lead Submission",
  ...
  return (
    <div className="w-full max-w-xl mx-auto overflow-hidden">
      ...
      <div className="px-4 py-6 sm:p-8 bg-white">
        ...
        {currentStep === 4 && (
          <SurveyFormStep8
            additionalText={`Your request has been submitted successfully. You should expect to hear from ${contractorName} or a Chooz Electricians representative soon.`}
          />
        )}
      </div>
    </div>
