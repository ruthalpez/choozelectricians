              ...
              .map((score, index) => (
                <div className="flex items-center gap-4" key={index}>
                  ...
                  {score.score >= 94 && (
                    <Image
                      src={BadgeBestAward}
                      alt={`${contractor.title} has been given a Chooz Electricians ${contractor.awards} Award in gold badge in 2025`}
                      width={85}
                      height={85}
                      priority
                  ...
                  {score.score >= 87 && score.score < 94 && (
                    <Image
                      src={BadgeTopAward}
                      alt={`${contractor.title} has been given a Chooz Electricians ${contractor.awards} Award in silver badge in 2025`}
                      width={85}
                      height={85}
                      priority
                      className="w-[85px] h-[85px] object-contain"
