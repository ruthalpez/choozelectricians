                  ...
                  {painter.scores?.map((score, i) => (
                    <div key={i}>
                      {score.score >= 94 && (
                        <Image
                          src={BadgeBestAward}
                          alt={`${painter.title} has been given a Chooz Electricians ${painter.awards} Award in gold badge in 2025`}
                          width={85}
                          height={85}
                          priority
                      ...
                      {score.score >= 87 && score.score < 94 && (
                        <Image
                          src={BadgeTopAward}
                          alt={`${painter.title} has been given a Chooz Electricians ${painter.awards} Award in silver badge in 2025`}
                          width={85}
                          height={85}
                          priority
                          className="w-[85px] h-[85px] object-contain"
                      ...
                      {score.score >= 80 && score.score < 87 && (
                        <Image
                          src={BadgeVerified}
                          alt={
                            "Chooz Electricians Certified badge in 2025 for S & M Painter & Drywall Co"
                          }
                          width={78}
                          height={78}
          ...
          <div className="mt-8 mb-12 about-text">
            ...
            <div className="about-text">
              {painter.description ? (
                ...
                <>
                  <p className="mb-6">
                    {painter.title} - Electricians in {painter.city} City,{" "}
                    {painter.state}.
                  </p>
                    ...
                    <AccordionTrigger className="text-left text-[15px] font-bold">
                      <Link
                        href={`/${location
                          ...
                          .split(", ")[0]
                          .toLowerCase()
                          .replace(" ", "-")}/electricians-contractors`}>
                        {location}
                      </Link>
                    </AccordionTrigger>
                    <AccordionContent>
