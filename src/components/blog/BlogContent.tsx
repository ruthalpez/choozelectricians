    ...
    <div className="w-full lg:w-3/4">
      {id === "1" && (
        <div className="space-y-4 mb-6">
          ...
          <ul className="space-list mb-4 list-disc pl-5">
            <li>
              <b>The Power of the Accent Wall:</b> Electricians just one wall in a
            ...
            <li>
              ...
              brighten the entire room significantly. Electricians interior doors
          ...
          <p>Happy Electricians!</p>
          <p>choozelectricians.com</p>
        </div>
      )}
      {id === "2" && (
        <div className="space-y-4 mb-6">
          ...
          <ul className="space-list mb-4 list-decimal pl-5">
            ...
            <li>
              <b>Time and Convenience:</b> Electricians can be time-consuming,
