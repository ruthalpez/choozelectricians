      ...
      <DialogContent className="bg-white h-[95vh] !max-w-[700px] overflow-y-auto">
        <DialogHeader className="">
          <DialogTitle className="text-[26px] font-bold px-4 pt-3">
            Understanding the Chooz Electricians Score
          </DialogTitle>
          <DialogDescription className="space-y-10 p-4">
            <div className="space-y-3">
              <p>
                At Chooz Electricians, we believe property owners (both residential
                and commercial) deserve transparent, data-driven insights when
                selecting a Electricians Contractor. Our proprietary Chooz Electricians
            ...
            <div className="space-y-3">
              ...
              <ul className="list-disc pl-5 space-y-4 mb-5">
                ...
                <li>
                  <b>Communication & Work with Chooz Electricians</b> - We believe
            ...
            <div className="space-y-3">
              ...
              <p>
                ...
                guidance because we've found that higher Chooz Electricians Scores
            ...
            <div className="space-y-3">
              <h2 className="text-[22px] font-bold">
                The Chooz Electricians Commitment
              </h2>
              <p>
                The Chooz Electricians Score represents more than just a number—it's
                our commitment to:
              </p>
              <ul className="list-disc pl-5 space-y-4 mb-5">
                <li>
                  Helping property owners find exceptional Electricians Contractors
                  with confidence
                </li>
                <li>
