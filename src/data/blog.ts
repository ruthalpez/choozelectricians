export const blogs = [
  {
    _id: "1",
    title:
      "Budget-Friendly Electricians: How to Refresh Your Space Without Breaking the Bank",
    excerpt:
  ...
  },
  {
    ...
    alt: "Smiling couple sitting on floor after completing a home Electricians project, surrounded by paint cans, brushes, and ladder",
  },
].map((blog) => ({
  ...blog,
  slug: blog.title
